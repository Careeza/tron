...
void MainMenuScene::initScene(GameWindow& window) {
	...
	Button play(window.getRenderer(), {105, 370, 701, 111}, NULL);
	play.addOverTexture(window.getRenderer(), {15, 166, 255, 152});
	Button multiPlayer(window.getRenderer(), {105, 540, 701, 111}, NULL);
	...
	Button exit(window.getRenderer(), {108, 934, 185, 74}, exitButtonOff);
