...
#	pragma GCC diagnostic pop
		...
		/** @fn template<typename Ftype> int Client::sendDirect(const Ftype pParameterArray, int arrSize, const Common::JVector<int>& targetPlayers, bool fallbackRelay)
		   @overload
		...
		/** @fn template<typename Ftype> int Client::sendDirect(const Ftype pParameterArray, const int* pArrSizes, const Common::JVector<int>& targetPlayers, bool fallbackRelay)
		   @overload
